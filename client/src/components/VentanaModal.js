      ...
      <Modal {...this.props} size="lg" aria-labelledby="miModal" centered>
        <Modal.Header closeButton className="modal-header">
          <Modal.Title id="miModal">
            {this.props.cabecera.toUpperCase()} -{" "}
            <small>Esta es una guía informativa</small>
          </Modal.Title>
        </Modal.Header>
        <Modal.Body scrollable="true">
          <div>
            ...
            <div>
              ...
              <h5>
                Este medicamento podría provocar algunos efectos secundarios
                tales como:
              </h5>
              <ul>
                {this.state.data.ad
            ...
            <div>
              <h6>Para más información visita:</h6>
              <p>
                <a
                  href={
                    "https://quefarmacia.com/medicamentos/" +
                    this.props.cabecera
                  }
                >
                  https://quefarmacia.com/medicamentos/{this.props.cabecera}
                </a>
              </p>
              <center>
                <blockquote>
                  Consulta a tu médico siempre <br /> NO te automediques
                </blockquote>
              </center>
            </div>
          </div>
